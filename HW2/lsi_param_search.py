...
for chunksize in np.arange(5000, 30001, 5000):
    ...
    lsi_similarity_indices[chunksize] = similarities.MatrixSimilarity(lsi[corpus], num_features=100)
...
with open('lsi_similarities_num_topics_chunksize.pickle', 'wb') as f:
